...
\section{Methodology}
	...
	{Manually defined gravel, asphalt, and side-of-road areas were projected onto the classified point cloud. Manually defined gravel, asphalt, and side-of-road areas were then used to determine the accuracy of the terrain classification algorithm. Classified point clouds were then manually examined to determine if the location of gravel and asphalt surfaces may be identified. If consecutive points from each channel in any direction had two or more matching gravel or asphalt classification and was evenly spaced, a gravel or road surface area was projected. Guessed road surface areas were then compared to actual areas to determine the method's ability at unmarked gravel road discovery.}
